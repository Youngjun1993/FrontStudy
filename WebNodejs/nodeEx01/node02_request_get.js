...
var url = require('url');
//	접속한 url에서 변수와 데이터(get방식)를 객체로 만드는 모듈을 생성
var querystring = require('querystring');

//2. http객체를 이용하여 서버 생성
var server = http.createServer((request, response)=>{
	//클라이언트에서 ---- get방식 ---- 으로 데이터를 서버로 보낸경우
	...
	response.write('<li>tel : ' + parseQuery.tel + "</li>");
	response.write("</ol>");
	response.end("<a href='http://127.0.0.1:10002?num=545&username=이영준&tel=010-4993-0706'>클릭</a>");
});

//3 접속대기
server.listen(10002,()=>{
	console.log('server start....   http://127.0.0.1:10002?num=1234&username=홍길동&tel=010-2123-1241');
});